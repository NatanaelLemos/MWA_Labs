...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"4dm1nP455w0rd"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"admin"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"restUser"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"P455w0rd"}
